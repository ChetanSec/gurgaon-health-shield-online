  ...
  return <MainLayout>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
            {insuranceProviders.map((insurer, index) => <InsuranceCard key={index} name={insurer.name} logo={insurer.logo} description={insurer.description} />)}
          </div>
        </div>
      </section>
      ...
      <section className="bg-securenow-orange text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <a href="/quotation" className="inline-block bg-white text-securenow-orange hover:bg-gray-100 py-3 px-8 rounded-md text-lg font-medium transition duration-150 ease-in-out">
            Get a Quote
          </a>
        </div>
      </section>
